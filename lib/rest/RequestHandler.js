...
class RequestHandler {
     ...
     */
    request(method, url, auth, body, file, _route, short, avoidRetry = false) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const actualCall = (cb) => {
                const headers = {
                    ...
                    "X-Super-Properties": ""
                };
                let data;
                let finalURL = url;
                ...
                try {
                    ...
                    if(file) {
                        ...
                        if(body) {
                            // The body should be combined into a JSON object under the "payload_json" field
                    ...
                    _respStream.on("data", (str) => {
                        ...
                        if(resp.statusCode >= 300) {
                            if(resp.statusCode === 429) {
                                ...
                                // Only retry if the ratelimit is less than 5s
                                if(avoidRetry && retryAfter > 5000) {
                                    this._client.emit("debug", "avoiding request retry");
                                    // Make sure we call the callback after the ratelimit is over
                                    setTimeout(() =>   cb(), retryAfter);
                                    resolve({ avoidedRetry: true });
                                    return;
                                }
                                if(delay) {
                                    setTimeout(() => {
