        ...
        switch(packet.t) {
            ...
            case "THREAD_LIST_SYNC": {
                if(this.client.options.userBot && !packet.d.members) {
                    ...
                    if (this.requestThreadsPromise.hasOwnProperty(guildID)) {
                        this.requestThreadsPromise[guildID].threads.push(...packet.d.threads);
                        clearTimeout(this.requestThreadsPromise[guildID].timeout);
                        this.requestThreadsPromise[guildID].res(this.requestThreadsPromise[guildID].threads);
                        delete this.requestThreadsPromise[guildID];
                    }
                    break;
                }
